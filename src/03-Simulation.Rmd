...
p <- ggplot() +
  ...
  geom_hline(yintercept = as.double(ML_NAIVE_RESULTS[[2]]), linetype = "dashed", colour = purple, alpha=transparency) +
  geom_point(aes(x = as.double(ML_NAIVE_RESULTS[[3]]), y = as.double(ML_NAIVE_RESULTS[[2]])), color = purple, size = 3) +
