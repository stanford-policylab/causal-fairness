...
for (E_0 in list(0.75,1)) {
  for (E_R in list(-0.75,-1)) {
    for (E_NOISE in list(0.75,1)) {
      for (M_E in list(0.75,1)) {
        for (M_NOISE in list(0.75,1)) {
          for (T_M in list(3,4)) {
            for (T_E in list(3,4)) {
              for (T_E_M in list(0.75,1)) {
                for (T_NOISE in list(3,5)) {
