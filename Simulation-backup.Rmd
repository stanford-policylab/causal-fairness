...
head(sort(df_test$ml_outcomes_pred_par,decreasing=TRUE), n = POP_SIZE_TEST_ADMIT)
...
for (coeff in 0:100) {
  ...
  max_weight = -0.15
  weight_r = max_weight * coeff/100 -0.15
...
```{r pareto_curve_02}
N=round(POP_SIZE_TEST_ADMIT)  * FRAC_BLACK * 2

MAX_BLACK_ADMIT = POP_SIZE_TEST_ADMIT * FRAC_BLACK* 2
pareto_ideal = NULL
...
p <- ggplot() +
 ...
 #coord_cartesian(xlim = c(0.0, 0.44),ylim = c(0.435, 0.633),expand = FALSE) + 
